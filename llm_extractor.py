...
_TREATMENT_EXTRACT_PROMPT = (
    "Was a drug, compound, exposure, or intervention applied to this sample?\n"
    ...
    "  'smoking: 1' or 'smoking: 2' or 'current/former smoker' → Smoking\n"
    "  'smoking: 0' or 'never smoker' or 'non-smoker' → Not Specified (0 = never = NO exposure)\n"
    "  'treatment: vehicle' → Untreated\n"
    "\n"
    "WRONG EXAMPLES (these are diseases/conditions, NOT treatments):\n"
    "  'disease status: HIV+' → WRONG: 'HIV Infection'. Correct: Not Specified\n"
    "  'diagnosis: Depression' → WRONG: 'Depression'. Correct: Not Specified\n"
    "  'disease state: Down syndrome' → WRONG: 'Down Syndrome'. Correct: Not Specified\n"
    "  'disease status: Multiple sclerosis' → WRONG: 'MS'. Correct: Not Specified\n"
    "  'group: control' → WRONG: 'Control'. Correct: Not Specified\n"
    "  'subject status: severely obese' → WRONG: 'Obese'. Correct: Not Specified\n"
    "\n"
    "ALSO NOT treatments (output Not Specified for ALL of these):\n"
    "  - Tissues/organs: blood, liver, adipose, cortex\n"
    "  - Lab/sample processing protocols: Illumina, Standard Illumina Protocol,\n"
    "    AllPrep, DNA extraction, RNA extraction, RNAlater, Ambion, TRIzol,\n"
    "    fresh frozen, FFPE, snap frozen, biobank protocol — these describe\n"
    "    HOW the sample was processed, NOT a treatment given to the patient\n"
    "  - Sample IDs: CXMA-01-125, batch codes, subject numbers\n"
    "  - Disease names are NEVER treatments\n"
    "  - Ambiguous 2-3 letter abbreviations without context (e.g. 'Dep', 'Ctl')\n"
    "    — if you cannot determine the full drug name, output Not Specified\n"
    "\n"
